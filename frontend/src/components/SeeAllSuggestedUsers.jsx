...
function SeeAllSuggestedUsers() {
	...
	return (
		<div className='mt-20 w-[32rem] m-auto flex flex-col items-start justify-center'>
			<h1 className='font-semibold mb-4'>Suggested</h1>
			{
				suggestedUsers && suggestedUsers.map((user) => {
					return (
						<div key={user._id} className='flex w-[32rem] items-center my-3 pl-2 justify-between'>
			...
			<div className="flex w-[26rem] m-auto justify-center flex-wrap gap-x-4 gap-y-2 text-xs text-[#695e69] mt-16 mb-4">
				<span>Meta</span>
				<span>About</span>
				<span>Blog</span>
				<span>Jobs</span>
