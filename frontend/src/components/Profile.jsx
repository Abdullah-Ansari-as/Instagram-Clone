			...
			<div className="flex w-[67rem] flex-col gap-10 pl-20 py-8 ">
								...
								<span className='text-lg font-semibold'>{userProfile?.username}</span>
								{
									isLoggedInUserProfile ? (
										...
										isFollowing ? (
											...
											<>
												<Button className='bg-[#0095f6] hover:bg-[#0e80cc] h-8 rounded ml-6'>Follow</Button>
												<Button variant='secondary' className='bg-[#eeeded] hover:bg-[#dbdbdb] h-8 rounded'>Message</Button>
											</>
										)
				...
				<div className='border-t border-t-gray-200'>
					<div className="flex items-center justify-center gap-10 text-sm">
						...
						<span className={`py-3 cursor-pointer flex items-center ${activeTab === 'reels' ? 'font-semibold border-t border-t-slate-800' : ""}`}><Video className='h-[14px]' /> REELS</span>
						<span className={`py-3 cursor-pointer flex items-center ${activeTab === 'tagged' ? 'font-semibold border-t border-t-slate-800' : ""}`}><Contact className='h-[14px]' /> TAGGED</span>
					</div>
				</div>
					...
					displayedPost.length > 0 ?
						(
							...
							<div className='flex justify-center items-center flex-col m-auto'>
								<div className='my-5'><TbCameraShare className='h-14 w-14' /></div>
								<h1 className='text-2xl font-extrabold'>Share Photos</h1>
								<p className='text-sm my-3'>When you share photos, they will appear on your profile.</p>
								<span className='text-md font-semibold text-blue-500'>see your first photo</span>
