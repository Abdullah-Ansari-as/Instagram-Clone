...
// Configuration
cloudinary.config({
	cloud_name: process.env.CLOUDINARY_CLOUD_NAME || "dlvgyg91m",
	api_key: process.env.CLOUDINARY_API_KEY || "958538299456727",
	api_secret: process.env.CLOUDINARY_API_SECRET || "nFtEC0-vsF11JJ6XudlWb9n-7Mg"
});
